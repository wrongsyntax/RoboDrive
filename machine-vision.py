...
import cv2
import pickle
import undistortion_function as uf
import time
import pdb
...
# frameHeight = 480
# brightness = 180
threshold = 0.70    #was 70     # PROBABLITY THRESHOLD
font = cv2.FONT_HERSHEY_SIMPLEX
##############################################
 
# puts image in grayscale
def grayscale(img):
...
while(True):
    ...
    # cap = luf.live(cv2.VideoCapture(1))
    ...
    while True:
        ...
        while(True):
            ...
            cap1 = cap
            cap1 = uf.undistort(imgOriginal)

            # ret, imgOriginal = cap1.read()
        ...
        #classesI = np.argmax(classIndex,axis=1)
